...
let nombreE13 = prompt("Ingrese su nombre:");
let apellido = prompt("Ingrese su apellido:");
let dni = prompt("Ingrese su número de documento:");
...
let genero = prompt("Ingrese su género (Masculino/Femenino/Otro):");

console.log("Datos ingresados:");
console.log("Nombre:", nombreE13);
